...
$(function () {
   ...
   $('.levels').click(function () {
      if($(this).hasClass("level1")) {
          ...
          lastVolume = 0.33;
          volumeController = 0;
          $(this).children('.inside-circle').css({background:"border: 2px solid #333333"});
          $('.level2 .inside-circle').css({background:"border: 2px solid #727375"});
          $('.level3 .inside-circle').css({background:"border: 2px solid #727375"});
          ...
          volumeController=0;
          $(this).children('.inside-circle').css({background:"border: 2px solid #333333"});
          $('.level1 .inside-circle').css({background:"border: 2px solid #333333"});
          $('.level3 .inside-circle').css({background:"border: 2px solid #727375"});
          console.log(audio.volume);
      }
          ...
          volumeController=0;
          $('.level1 .inside-circle').css({background:"border: 2px solid #333333"});
          $('.level2 .inside-circle').css({background:"border: 2px solid #333333"});
          $('.level3 .inside-circle').css({background:"border: 2px solid #333333"});
          console.log(audio.volume);
      }
   });
